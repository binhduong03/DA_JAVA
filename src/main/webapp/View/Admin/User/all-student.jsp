...
function doDelete(id) {
	if (confirm("Bạn có chắc chắn muốn xóa người dùng với id = "+id+ " không?")){
				...
				<div class="card-body">
						...
						<div class="row align-items-center">
							...
							<div class="col-auto text-end float-end ms-auto download-grp">
								...
								<a href="#" class="btn btn-outline-primary me-2"><i
									...
									href="add-student" class="btn btn-primary"><i
					...
					<div class="table-responsive">
						<table
							...
							<tbody>
								<c:forEach items="${student }" var="all" varStatus="status">
									<tr>
									...
									<td class="text-end">
										<div class="actions">
											<a href="javascript:;"
												...
												class="feather-eye"></i>
											</a> <a href="update-student?id=${all.user_id }"
